...
RESOLVER_NAME = 'sceptre-aws-ami-resolver'
# the resolver call in sceptre e.g. !command_name.
RESOLVER_COMMAND_NAME = 'aws_ami'
...
RESOLVER_CLASS = 'AwsAmi'
# One line summary description
RESOLVER_DESCRIPTION = 'A Sceptre resolver to retrieve EC2 Image ID from AWS'
# if multiple use a single string with comma separated names.
RESOLVER_AUTHOR = 'harisfauzi'
# if multiple use single string with commas.
RESOLVER_AUTHOR_EMAIL = 'haris.fauzi@gmail.com'
